...
export const CTAButton: React.FC<CTAButtonProps> = ({
  ...
  let containerClasses =
    variant === 'primary'
      ...
      ? 'bg-black h-4 min-w-[40px] w-auto rounded-tl-[5px] rounded-br-[5px] flex justify-center items-center hover:border-white hover:border cursor-pointer'
      : variant === 'deckViewCategory'
      ? 'w-auto p-2 h-5 rounded-xl bg-black flex justify-center items-center hover:border-white hover:border cursor-pointer'
      : variant === 'addCard'
